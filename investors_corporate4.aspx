<%@ Page Language="C#" AutoEventWireup="true" CodeFile="investors_corporate4.aspx.cs" Inherits="investors_corporate4" %>
                ...
                <div class="col-md-4">
                    <div class="golgelendirme2">
                        <ul>
                            ...
                            <li style="margin-left: 17px;">
                                <h4 style="margin-left: -17px; color: #072C50;"><strong><a href="investors_corporate4.aspx">General Assembly</a> </strong></h4>
                            </li>
                            <li style="margin-left: 17px;">
                                <h4 style="margin-left: -17px; color: #072C50;"><a href="investors_corporate3.aspx">Documents</a></h4>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-8 corporate docs mb-100">
                    ...
                    <ul>
                        <asp:Repeater runat="server" ID="rptGeneralAssembly">
                            <ItemTemplate>
