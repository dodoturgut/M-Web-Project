...
public partial class investors_financialreports1 : System.Web.UI.Page
{
    ...
    {
        baglanti.Open();
        MySqlCommand komut = new MySqlCommand("SELECT * FROM files WHERE page='Financial Reports'  AND year = '" + newDate + "' AND header='Interim reports'", baglanti);
