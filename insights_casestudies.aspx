<%@ Page Language="C#" AutoEventWireup="true" CodeFile="insights_casestudies.aspx.cs" Inherits="insights_casestudies" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="css/insights_casestudies.css">
...
<%--                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 menu2" style="margin-top: 80px; left: 0; height: 40px; background-color: #f2f2f2; z-index: 99;">
                                        <div class="col-md-12 col-sm-9 col-xs-12 yukseklik">
                                            <div class="alt-sol-yan container" style="color: black; top: 10%; left: 12%;">
                                                <div class="solTarafaltmenu">
                                                    <ul class="menuAlt navborder">
                                                        <li><a href="insights_blog.aspx" style="color: black !important;">Blog</a></li>
                                                        <li><a class="active" href="insights_casestudies.aspx" style="color: black !important;">Case Studies</a></li>
        ...
        <div class="col-md-8 col-sm-8 col-xs-12 floatleft">
            <div class="insightBox">
                <h2>Blog</h2>
                <h2 class="active">Case Studies</h2>
                <h2>Whitepapers</h2>
                <h2>Gallery</h2>
            </div>
        </div>
        ...
        <section>
            <div class="container">
                <div class="insightsCard">
                    <div class="">
                        <div class="firstCard1" style="">
                            <div class="firstCard1Img">
                            </div>
                            <div class="firstCardDiv">
                                <div class="cardFlex">
                                    <div style="display: flex; justify-content: space-between;">
                                        <h5 style="font-size: 15px; font-weight: 600; color: gray;">AUGUST 2021</h5>
                                        <h5 style="font-size: 15px; font-weight: 600;">6 MINUTE READ</h5>
                                    </div>
                                    <h3>Weighing the Advantages and Disadvantages of Outsourcing</h3>
                                    ...
                                    <h5><a href="insights_blog_technology.aspx?blogID=7">READ MORE</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="insightsCard">
                    <div class="">
                        <div class="secondCard1">
                            <div class="secondCardDiv">
                                <div class="cardFlex">
                                    <div style="display: flex; justify-content: space-between;">
                                        <h5 style="font-size: 15px; font-weight: 600; color: gray;">AUGUST 2021</h5>
                                        <h5 style="font-size: 15px; font-weight: 600;">5 MINUTE READ</h5>
                                    </div>
                                    <h3>The Difference Between Nearshoring and Offshoring</h3>
                                    <p style="font-size: 16px;">
                                        Outsourcing is rapidly evolving into one of the most valuable tools for business growth. Though studies from analysts like Deloitte demonstrate outsourcing has been a fantastic resource for companies for some time, global events, like the pandemic, have demonstrated just how important it is to have access to the right talent whenever you need it.
                                    </p>
                                    <h5><a href="insights_blog_technology.aspx?blogID=6">READ MORE</a></h5>
                                </div>
                            </div>
                            <div class="secondCard1Img">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="insightsCard">
                    <div class="">
                        <div class="firstCard1 thirdBorder" style="">
                            <div class="firstCard1Img">
                            </div>
                            <div class="firstCardDiv">
                                <div class="cardFlex">
                                    <div style="display: flex; justify-content: space-between;">
                                        <h5 style="font-size: 15px; font-weight: 600; color: gray;">AUGUST 2021</h5>
                                        <h5 style="font-size: 15px; font-weight: 600;">7 MINUTE READ</h5>
                                    </div>
                                    <h3>3 Golden Rules For More Engaged Customers</h3>
                                    <p style="font-size: 16px;">
                                        Customer engagement is something no company can afford to underestimate, or overlook. If you want your clients to keep coming back to your business time after time, you need to commit to keeping them engaged. Unfortunately, that’s easier said than done.
                                    </p>
