<%@ Page Language="C#" AutoEventWireup="true" CodeFile="insights_blog.aspx.cs" Inherits="insights_blog" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="css/processconsultancy.css">
    ...
    <link rel="stylesheet" href="css/customerengagementMobile.css">
    <link rel="stylesheet" href="css/investors/init.css">
    <link rel="stylesheet" href="css/insights/insights_blog.css">
    <link rel="stylesheet" href="css/investors/init.css">
</head>
<body>
    <form id="form1" runat="server">
                                            ...
                                            <div class="alt-sol-yan container-fluid-custom" style="color: black; top: 10%; left: 12%;">
                                                <div class="solTarafaltmenu">
                                                    <ul class="menuAlt navborder">
                                                        <li><a class="active" href="insights_blog.aspx" style="color: black !important;">Blog</a></li>
                                                        <li><a href="insights_casestudies.aspx" style="color: black !important;">Case Studies</a></li>
                                                        <li><a href="insights_blog_technology.aspx" style="color: black !important;">Whitepapers </a></li>
        ...
        <!--<div class="containerInsigths1 paddingTop50 paddingBottom100">
        <div class="col-md-8 col-sm-8 col-xs-12 floatleft">
            <div class="insightBox">
                <h2 class="active">Blog</h2>
                <h2>Case Studies</h2>
                <h2>Whitepapers</h2>
                <h2>Gallery</h2>
            </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-12 floatright">
            <div class="insightBox">
                <h2>Additional filters</h2><i class="fas fa-plus fa-3x"></i>
            </div>
        </div>
    </div>-->


        <section class="consultancy-section" style="background-image: url('./images/insightsBg.png');">
            <span class="playside" style="height: 500px;"></span>
            <div class="container container-fluid-custom">

                <div class="row">
                    <div class="col-md-7">
                        <p class="font-size-45 white-color line-height-1">Insights</p>
                    </div>
                </div>
            </div>
        </section>

        <section class="paddingBottom100 paddingTop100">
            <div class="container-fluid-custom">

                <div class="row">
                    <div>
                        <div class="col-md-6 col-sm-12 col-12" style="padding: 0;">

                            <img src="../../images/insightContent.png" style="height: 434px; width: 100%;">
                        </div>
                        <div class="col-md-6 col-sm-12 col-12 insightsText">
                            <div class="featured-content-info">
                                <span style="color:#ef4436;">APRIL, 2022</span>
                                <span style="color:#ef4436;">5 MINUTE READ</span>
                            </div>
                            <h4>FEATURED CONTENT</h4>
                            <h3>Using ecommerce Outsourcing to Improve
                                Customer Care</h3>
                            <p>
                                Customer service is a critical consideration for any business.
                            </p>
                            <p>
                                It doesn’t matter what you sell or where
you sell it, delivering the right customer service is essential for creating loyal customers.
                            </p>
                            <div class="insightsBt" onclick="location.href='./insights_blog_technology.aspx?blogID=3'"  style="cursor:pointer;">Explore<i class="fas fa-plus fa-lg"></i></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid-custom">
                <%-- <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="row">
                            <div class="col-12 col-md-5 col-lg-5  pad-5">
                                <div class="card1">
                                    <div>
                                        <img class="w-100" src="images/In1.png" />
                                        <div>
                                            <div style="display: flex; justify-content: space-between; margin-top: 25px;">
                                                <h5 style="font-size: 15px; font-weight: 600; color: gray;">AUGUST 2021</h5>
                                                <h5 style="font-size: 15px; font-weight: 600; color: gray; text-align: end;">5 MINUTE READ</h5>
                                            </div>
                                            <h2 style="font-weight: 600; margin-top: 10px;">The Difference Between Nearshoring and Offshoring
                                            </h2>
                                            <h5 style="margin-top: 30px; font-size: 15px; font-weight: 600; color: gray;"><a href="insights_blog_technology.aspx?blogID=6">READ MORE</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3 pad-5">
                                <div class="card1">
                                    <div class="">
                                        <div>
                                            <img class="w-100" src="images/In1.png" />
                                            <div>
                                                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                                    <h5 style="font-size: 11px; font-weight: 400; color: gray;">AUGUST 2021</h5>
                                                </div>
                                                <h2 style="font-weight: 600; margin-top: 0px;">3 Golden Rules For More Engaged Customers
                                                </h2>
                                                <p style="font-size: 14px; margin-top: 10px; color: grey;">Customer engagement is something no company can afford to underestimate, or overlook. If you want your clients to keep coming...</p>
                                                <h5 style="margin-top: 20px; font-size: 15px; font-weight: 600; color: gray;"><a href="insights_blog_technology.aspx?blogID=5">READ MORE</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4 pad-5">
                                <div class="card1">
                                    <div class="">
                                        <div>
                                            <img class="w-100" src="images/In1.png" />
                                            <div>
                                                ...
                                                <h2 style="font-weight: 600; margin-top: 0px;">Weighing the Advantages and Disadvantages of Outsourcing</h2>
                                                <p style="font-size: 14px; margin-top: 10px; color: grey;">For years, the concept of outsourcing has been...</p>
                                                <h5 style="margin-top: 20px; font-size: 15px; font-weight: 600; color: gray;"><a href="insights_blog_technology.aspx?blogID=7">READ MORE</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-8 col-lg-8">
                        <div class="row">
                            <div class="col-12 col-md-7 col-lg-7  pad-5">
                                <div class="card1">
                                    <div>
                                        <img class="w-100" src="images/In1.png" />
                                        <div>
                                            ...
                                            <h2 style="font-weight: 600; margin-top: 10px;">Weighing the Advantages and Disadvantages...
                                            </h2>
                                            <h5 style="margin-top: 30px; font-size: 15px; font-weight: 600; color: gray;"><a href="insights_blog_technology.aspx?blogID=7">READ MORE</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-5 col-lg-5 pad-5">
                                <div class="card1">
                                    <div class="">
                                        <div>
                                            <img class="w-100" src="images/In2.png" />
                                            <div>
                                                <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                                    <%--                                                    <h5 style="font-size: 11px; font-weight: 400; color: gray;">AUGUST 2021</h5>--%>
                                                </div>
                                                <h2 style="font-weight: 600; margin-top: 0px;">The Difference Between Nearshoring and Offshoring
                                                </h2>
                                                <p style="font-size: 14px; margin-top: 10px; color: grey;">Outsourcing is rapidly evolving into one of the most valuable tools for business growth. Though studies from analysts like Deloitte demonstrate outsourcing has been a fa...</p>
                                                <h5 style="margin-top: 20px; font-size: 15px; font-weight: 600; color: gray;"><a href="insights_blog_technology.aspx?blogID=6">READ MORE</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mtop-20">
                            <div class="col-12 col-md-6 col-lg-6 pad-5">
                                <div class="">
                                    <div class="rightCard1" style="box-shadow: 0 0 10px rgba(0,0,0,.1);">
                                        <div class="cardDiv">
                                            <div class="cardFlex">
                                                <div style="display: flex; justify-content: space-between;">
                                                    <%--                                                    <h5 style="font-size: 11px; font-weight: 500; color: gray;">AUGUST 2021</h5>--%>
                                                </div>
                                                <h3>3 Golden Rules For More Engaged Customers</h3>
                                                <h5><a href="insights_blog_technology.aspx?blogID=5">READ MORE</a></h5>
                                            </div>
                                        </div>
                                        <div class="rightCard1Img">
                                            <img src="images/custCardImg2.png" />
                                        </div>
                                    </div>
                                    <div class="rightCard1" style="border-top: 5px solid #29abe2; box-shadow: 0 0 10px rgba(0,0,0,.1);">
                                        <div class="cardDiv">
                                            <div class="cardFlex">
                                                <div style="display: flex; justify-content: space-between;">
                                                    <%--                                                    <h5 style="font-size: 11px; font-weight: 500; color: gray;">AUGUST 2021</h5>--%>
                                                </div>
                                                <h3>Defining the Business of Experience: A Holistic Strategy</h3>
                                                <h5><a href="insights_blog_technology.aspx?blogID=4">READ MORE</a></h5>
                                            </div>
                                        </div>
                                        <div class="rightCard1Img">
                                            <img src="images/custCardImg3.png" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6 pad-5">
                                <div class="card-3" style="border-top: 5px solid #072c50;">
                                    <div>
                                        <img class="w-100" src="images/custCardImg1.png" />
                                        <div>
                                            <div style="display: flex; justify-content: space-between; margin-top: 25px;">
                                                <%--                                                <h5 style="font-size: 11px; font-weight: 500; color: gray;">AUGUST 2021</h5>--%>
                                            </div>
                                            <h2 style="font-weight: 600; margin-top: 10px;">Why should I care about assuring quality in a Contact center?
                                            </h2>
                                            <h5 style="margin-top: 30px; font-size: 15px; font-weight: 600; color: gray;"><a href="insights_blog_technology.aspx?blogID=6">READ MORE</a></h5>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-4 pad-5">
                        <div class="latest-stories">
                            <div class="header">
                                <h3 style="font-weight: 600; margin-top: 0px;">Latest Stories</h3>
                            </div>
                            <div class="body">
                                <div class="body-item" onclick="location.href='./insights_blog_technology.aspx?blogID=7'" style="cursor:pointer;">
                                    <div class="row">
                                        <div class="col-5 col-md-5 col-lg-5 col-xs-5">
                                            <img src="images/custCardImg2.png" />
                                        </div>
                                        <div class="col-7 col-md-7 col-lg-7 pad-0">
                                            <h4>Weighing the Advantages and Disadvantages of Outsourcing</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="body-item" onclick="location.href='./insights_blog_technology.aspx?blogID=6'" style="cursor:pointer;">
                                    <div class="row">
                                        <div class="col-5 col-md-5 col-lg-5 col-xs-5">
                                            <img src="images/In2.png" />
                                        </div>
                                        <div class="col-7 col-md-7 col-lg-7 pad-0">
                                            <h4>The Difference Between Nearshoring and Offshoring</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="body-item" onclick="location.href='./insights_blog_technology.aspx?blogID=5'" style="cursor:pointer;">
                                    <div class="row">
                                        <div class="col-5 col-md-5 col-lg-5 col-xs-5">
                                            <img src="images/custCardImg2.png" />
                                        </div>
                                        <div class="col-7 col-md-7 col-lg-7 pad-0">
                                            <h4>3 Golden Rules For More Engaged Customers</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="body-item" onclick="location.href='./insights_blog_technology.aspx?blogID=4'" style="cursor:pointer;">
                                    <div class="row">
                                        <div class="col-5 col-md-5 col-lg-5 col-xs-5">
                                            <img src="images/In2.png" />
                                        </div>
                                        <div class="col-7 col-md-7 col-lg-7 pad-0">
                                            <h4>Defining the Business of Experience: A Holistic Strategy</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="body-item" onclick="location.href='./insights_blog_technology.aspx?blogID=3'" style="cursor:pointer;">
                                    <div class="row">
                                        <div class="col-5 col-md-5 col-lg-5 col-xs-5">
                                            <img src="images/custCardImg2.png" />
                                        </div>
                                        <div class="col-7 col-md-7 col-lg-7 pad-0">
                                            <h4>Using ecommerce Outsourcing to Improve Customer Care</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
