...
public partial class investors_notifications : System.Web.UI.Page
{
    ...
    private void GeneralAssembly()
    {
        ...
        baglanti.Open();
        MySqlCommand komut = new MySqlCommand("SELECT * FROM files WHERE page='Notifications' AND year = '" + tarih + "'", baglanti);
        rptNotifications.DataSource = komut.ExecuteReader();
