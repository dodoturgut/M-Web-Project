<%@ Page Language="C#" AutoEventWireup="true" CodeFile="investors_corporate3.aspx.cs" Inherits="investors_corporate3" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="css/investors_corporate.css">
    <link rel="stylesheet" href="fontawesome-free-5.15.4-web/css/all.css">
    ...
    <link rel="stylesheet" href="css/investors_corporate.css" />
    <link rel="stylesheet" href="css/investors_corporate2.css" />
        ...
        <section class="consultancy-section" style="background-image: url('./images/ConsultancyNav1.png');">
           <span class="playside" style="height:500px;"></span>
            <div class="container container-fluid-custom">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <p class="font-size-45 white-color line-height-1">Corporate<br>
                                Governance</p>
                    </div>
                    <div class="col-md-5">
                        
                        <p class="pageTitleBread"> Home/Investors/Corporate-governance...</p>
                    </div>
                </div>
            </div>
        </section>

        <section class="paddingBottom100 paddingTop100"style="background-color: #f2f2f2;">
            <div class="container container-fluid-custom">
                <div class="row keyContainer">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <h3 style="color: #EF4436; text-align: left;" class="solutionHeader"><strong>CORPORATE GOVERNANCE</strong></h3>
                        <br />
                        <br />
                        <br />
                        <h2>M+ Group develops and acts in accordance with good practice of cooperative management and seeks to, with its business strategy, business policy, key bylaws and business practice, contribute to a transparent and effective business and to higher quality relations with the business environment in which it acts.</h2>
                    </div>
                </div>
            </div>
        </section>
    ...
    <section class="paddingBottom100 paddingTop100">
            <div class="container container-fluid-custom">
                <div class="col-md-4" style="padding: 0;">
                    <div class="golgelendirme2">
                        <ul>
                            <li style="margin-left: 17px;">
                                <h4 style="margin-left: -17px; color: #072C50;"><a href="investors_corparate2.html">Management Board</a></h4>
                            </li>
                            <li style="margin-left: 17px;">
                                <h4 style="margin-left: -17px; color: #072C50;"><a href="investors_corporate.html">Supervisory board</a></h4>
                            </li>
                            <li style="margin-left: 17px;">
                                <h4 style="margin-left: -17px; color: #072C50;"><a href="investors_corporate4.aspx">General Assembly</a></h4>
                            </li>
                            <li style="margin-left: 17px;">
                                <h4 style="margin-left: -17px; color: #072C50;"><strong><a href="investors_corporate3.aspx">Documents</a> </strong></h4>
                            </li>
                            <!--<li style="margin-left: 17px;"><h4 style="margin-left: -17px; color: #072C50;"> <a href="investors_corparate4.html"> General Assembly</a>  </h4></li>
                        <li style="margin-left: 17px;"><h4 style="margin-left: -17px; color: #072C50;"><strong><a href="investors_corparate2.html">Documents</a></strong> </h4></li>-->
                        </ul>
                    </div>
                </div>
                <div class="col-md-8 corporate">
                    <div class="corporateBox" style="padding-top: 0!important;">
                        <h3 style="margin-top: 20px;"><strong>The Articles of Association </strong></h3>
                        <asp:Repeater runat="server" ID="rptArticlesOfAssociation">
                            <ItemTemplate>
                                <img src="images/filedowload.png" alt="" />
                                <a href="<%# Eval("link") %>" target="_blank">
                                    <asp:Label runat="server" ID="name" Text='<%# Eval("name") %>'></asp:Label></a>
                                <br />
                                <br />
                            </ItemTemplate>
                        </asp:Repeater>
                    ...
                    <div class="corporateBox">
                        <h3><strong>Board’s policies</strong></h3>
                        <asp:Repeater runat="server" ID="rptBoardPolicies">
                            <ItemTemplate>
                                <img src="images/filedowload.png" alt="" />
                                <a href="<%# Eval("link") %>" target="_blank">
                                    <asp:Label runat="server" ID="name" Text='<%# Eval("name") %>'></asp:Label></a>
                    ...
                    <hr />
                    <div class="corporateBox">
                        <h3><strong>Other acts </strong></h3>
                        <asp:Repeater runat="server" ID="rptOtherActs">
                            <ItemTemplate>
                                <img src="images/filedowload.png" alt="" />
                                <a href="<%# Eval("link") %>" target="_blank">
                                    <asp:Label runat="server" ID="name" Text='<%# Eval("name") %>'></asp:Label></a>
                    ...
                    <hr />
                    <div class="corporateBox">
                        <h3><strong>Code of Corporate Governance</strong></h3>
                        <asp:Repeater runat="server" ID="rptCodeofCorporateGovernance">
                            <ItemTemplate>
                                <img src="images/filedowload.png" alt="" />
                                <a href="<%# Eval("link") %>" target="_blank">
                                    <asp:Label runat="server" ID="name" Text='<%# Eval("name") %>'></asp:Label></a>
                    ...
                    <div class="corporateBox">
                        ...
                        <asp:Repeater runat="server" ID="rptProspectus">
                            <ItemTemplate>
                                <img src="images/filedowload.png" alt="" />
                                <a href="<%# Eval("link") %>" target="_blank">
                                    <asp:Label runat="server" ID="name" Text='<%# Eval("name") %>'></asp:Label></a>
        ...
        <section style="background-color: #f2f2f2;">
            <div class="container-fluid-custom paddingTop100 paddingBottom100">
